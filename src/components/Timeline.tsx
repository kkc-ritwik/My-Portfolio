            ...
            {timelineData.map((item, index) => (
              ...
              >
                ...
                <div className="w-full md:w-1/2 pl-12 md:pl-8 md:pr-8">
                  <motion.div
                    whileHover={{ scale: 1.02, boxShadow: "0 10px 25px -5px rgba(59,130,246,0.4)" }}
                    className="backdrop-blur-sm bg-white/10 p-4 md:p-6 rounded-xl border border-blue-500/30 shadow-lg text-left"
                  >
                    <motion.span 
                      className="inline-flex items-center px-3 py-1 bg-blue-900/50 text-blue-200 rounded-full text-sm font-medium mb-2 border border-blue-500/30"
                      whileHover={{ scale: 1.05 }}
                    ...
                    {/* Decorative corner accent */}
                    <div className="absolute top-0 left-0 w-16 h-16 bg-gradient-to-br from-blue-500/20 to-transparent rounded-br-full"></div>
                  </motion.div>
                </div>
