...
const Gaming = () => {
  const platforms = [
    { icon: <FaYoutube className="text-red-600" />, name: "YouTube", url: "https://www.youtube.com/@ritwiksingh7589" },
    { icon: <FaTwitch className="text-purple-600" />, name: "Twitch", url: "https://www.twitch.tv/ritwiksinghkkc" },
    { icon: <FaSteam className="text-blue-600" />, name: "Steam", url: "https://steamcommunity.com/profiles/76561199848147390/home" },
    { icon: <SiEpicgames className="text-black" />, name: "Epic", url: "https://www.epicgames.com/account/personal?lang=en-US&productName=egs" },
    { icon: <SiRiotgames className="text-red-500" />, name: "Riot", url: "https://account.riotgames.com/in" },
  ];
    ...
    <section id="gaming" className="py-20 relative overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <motion.a
              href="https://www.youtube.com/@ritwiksingh7589"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full text-white font-bold shadow-lg hover:shadow-purple-500/50 inline-block"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Subscribe to My Channel
