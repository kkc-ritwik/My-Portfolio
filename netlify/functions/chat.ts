...
- Backend Developer (Freelance) at Triaxa FZCO: reactive microservices with Java 17, Spring Boot/WebFlux, Spring Cloud (Eureka, API Gateway, Circuit Breaker), Kafka, Docker, Kubernetes, OAuth2.
- Full Stack Developer (Freelance) at Sky Tech: full-stack software development and ongoing support.
